...
class BinaryOps(Enum):
  """A + A -> A (elementwise)"""
  ADD = auto(); SUB = auto(); MUL = auto(); MAX = auto(); MOD = auto(); CMPLT = auto(); CMPNE = auto(); XOR = auto() # noqa: E702
...
UNSAFE_PAD_OPS = {UnaryOps.LOG2, UnaryOps.EXP2}
...
python_alu = {
  ...
  UnaryOps.RECIP: lambda x: 1/x if x != 0 else x*math.inf,
  ...
  BinaryOps.IDIV: lambda x,y: x//y if y != 0 else x*math.inf,
